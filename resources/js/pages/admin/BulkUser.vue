<template>
  <div>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Export & Import Users</h1>
      <button
        type="button"
        ...
        <div class="card">
          <div class="card-body">
            <form>
              ...
              >
                <i class="fas fa-download fa-sm text-white-50"></i>&nbsp; Export User Data&nbsp;
              </button>
              <button
                type="submit"
...
export default {
  ...
  methods: {
    ...
    exportUser() {
      axios.get("/api/user/export-user-excel").then((res) => {
        if (res) {
