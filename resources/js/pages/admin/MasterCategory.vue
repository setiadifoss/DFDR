            ...
            <form>
              <div class="form-group">
                ...
                <small
                  ...
                  v-if="submitted && !$v.form.category_name.required"
                  ><i class="fa fa-info-circle text-xs"></i>&nbsp; Category name is required</small
                >
              </div>
              <button
                type="submit"
                ...
                v-if="updated == false"
                v-on:click.prevent="handleCreatedCategory()"
              >
                Submit
              </button>
              <button
...
export default {
  ...
  computed: {
    ...
    categories() {
      this.items = this.$store.getters.getAllCategories;
    },
  },
  mounted() {
  ...
  methods: {
    ...
    toDetail(id) {
      ...
      axios.get("/api/category/" + id).then((res) => {
        this.form.category_name = res.data.data.category.category_name;
        this.id = res.data.data.category.id;
        // console.log(this.id);
      });
    },
