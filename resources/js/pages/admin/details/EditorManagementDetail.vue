                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <small
                      ...
                      class="form-text text-muted"
                      v-if="submitted && !$v.form.email.required"
                      ><i class="fa fa-info-circle text-xs"></i>&nbsp; Place of Birhth is required</small
                    >
                  </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <small
                      ...
                      >harap pilih salah satu fakultas</small
                    >
                  </div>
                </div>
              </div> -->
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <small
                      ...
                      ><i class="fa fa-info-circle text-xs"></i>&nbsp; File format is not supported</small
                    >
                  </div>
                </div>
                <div class="col-md-6">
