<template>
  <div>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">Editors Management</h1>
      <router-link
        :to="{ name: 'EditorManagementAdd' }"
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch("getEditor");
  },
  methods: {
    toDetail(id) {
      const vm = this;
      vm.$router.push("/detail-editor-management/" + id);
    },
    toDelete(id) {
      Vue.swal({
        title: "Delete Data",
