            ...
            <form>
              <div class="form-group">
                ...
                >
                   ...
                   <b-form-checkbox v-model="yt_video" name="check-button" switch>
    </b-form-checkbox>
              <div class="form-group">

                <label for="photo" v-if="yt_video == true">Preview</label>
                <div v-if="form.path != null && yt_video == true">
              ...
              <div v-else>
              <label>Masukan alamat youtube</label>
                 <b-form-input
                  v-model="form.path"
                  type="search"
                  id="filterInput"
                  placeholder="https://www.youtube.com/watch?v=qXlZVDA_S_s"
                ></b-form-input>
              </div>
              </div>
              <button
...
export default {
  ...
  methods: {
    ...
    handleCreated() {
      ...
      formData.append("type" , this.yt_video == true ? 1 : 2),
