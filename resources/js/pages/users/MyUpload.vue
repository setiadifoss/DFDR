<template>
  <div>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800">My Deposit</h1>
...
export default {
  data() {
    return {
      ...
      perPage: 10,
      currentPage: 1,
      fields: ["title", "category", "descriptions", "status", "actions"],
      items: [],
    };
  },
  computed: {
    ...
    uploads() {
      this.items = this.$store.getters.getMyUpload;
    },
  },
  mounted() {
    this.$store.dispatch("getMyUpload");
  },
  methods: {
    toDetail(id) {
      const vm = this;
      vm.$router.push("/detail-my-upload/" + id);
    },
    toDelete(id) {
      Vue.swal({
        title: "Delete Data",
