<template>
  <div class="row">
    <div class="col-4">
      <img height="1080" :src="campusImage" alt="campus-image" />
    </div>
    <div class="col"></div>
    <div class="col-6">
      <div class="card-body">
        <div class="container">
          <h4 class="text-start text-dark font-weight-bold">Register</h4>
          <br /><br />
          <div>
            <form>
              <div class="row">
                <div class="col">
                  <div class="form-group">
                    <label for="name" class="text-dark font-weight-bold"
                      >Full Name</label
                    >
                    <input
                      type="text"
                    ...
                    <small
                      ...
                      ><i class="fa fa-info-circle text-xs"></i>&nbsp; Name is
                      required</small
                    >
                    <!-- <small
                      id="nameError"
                  ...
                  <div class="form-group">
                    <label class="text-dark font-weight-bold" for="phone"
                      >Phone Number</label
                    >
                    <input
                      type="text"
                    ...
                    <small
                      ...
                      ><i class="fa fa-info-circle text-xs"></i>&nbsp; Phone
                    ...
                    <small
                      ...
                      ><i class="fa fa-info-circle text-xs"></i>&nbsp; Phone
                      number should not less than 10 digits</small
                    >
                  </div>
                  <div class="form-group">
                    ...
                    <small
                      ...
                      ><i class="fa fa-info-circle text-xs"></i>&nbsp; Email is
                      required</small
                    >
                    <small
                      id="emailError"
                    ...
                    <small
                      ...
                      v-if="
                        sameEmail &&
                          ...
                          $v.form.email.email
                      "
                      ><i class="fa fa-times"></i>&nbsp; Email has been
                      registered, please use another email address</small
                    >
                  </div>
                </div>
                <div class="col"></div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <small
                      ...
                      class="form-text text-muted"
                      v-if="submitted && !$v.form.email.required"
                      ><i class="fa fa-info-circle text-xs"></i>&nbsp; Place of
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <small
                      ...
                      class="form-text text-muted"
                      ><i class="fa fa-info-circle text-xs"></i>&nbsp; Date of
                      Birth is required</small
                    >
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="text-dark font-weight-bold" for="department"
                      >Department</label
                    >
                    <select
                      class="form-control"
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="text-dark font-weight-bold" for="faculty"
                      >Faculty</label
                    >
                    <select
                      class="form-control"
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="text-dark font-weight-bold" for="gender"
                      >Gender</label
                    >
                    <select
                      class="form-control"
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="text-dark font-weight-bold" for="year"
                      >Year</label
                    >
                    <select
                      class="form-control"
              ...
              <div class="form-group">
                <label class="text-dark font-weight-bold" for="address"
                  >Address</label
                >
                <textarea
                  class="form-control"
                ...
                <small
                  ...
                  ><i class="fa fa-info-circle text-xs"></i>&nbsp; Address is
                  required</small
                >
              </div>
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="text-dark font-weight-bold" for="upload_card"
                    ...
                    <small
                      ...
                      ><i class="fa fa-info-circle text-xs"></i>&nbsp; ID Card
                      is required</small
                    >
                    <small
                      id="uploadError"
                      ...
                      ><i class="fa fa-times text-xs"></i>&nbsp; File format is
                      not supported</small
                    >
                  </div>
                </div>
  ...
  methods: {
    ...
    checkName() {
      if (this.form.name != "") {
        ...
        axios
          .post("/api/user/checkName", formData)
          .then((res) => {
            if (res.data.status == "Success") this.sameName = false;
            else this.sameName = true;
          })
          .catch((err) => {
            console.log(err);
          });
      } else this.sameName = false;
    },
    ...
    checkEmail() {
      if (this.form.email != "") {
        ...
        axios
          ...
          .then((res) => {
            if (res.data.status == "Success") this.sameEmail = false;
            else this.sameEmail = true;
          })
          .catch((err) => {
            console.log(err);
          });
      } else this.sameEmail = false;
    },
    ...
    checkSpecific() {
      if (
        ...
        axios
          .post("/api/user/checkSpecific", formData)
          .then((res) => {
            if (res.data.status == "Error") {
              ...
              Vue.swal({
                ...
                title:
                  "User named '" +
                  this.capFLetter(this.form.name) +
                  "' has been registered!",
                text:
                  "We detected data similarities between your input and a registered user. Please use Login instead of Registering",
              });
            } else this.sameAll = false;
          })
          .catch((err) => {
            console.log(err);
          });
        ...
        axios
          ...
          .then(function() {
            Vue.swal({
              ...
              text:
                "Please wait for your account verification proccess. We will send a notification to your email afterwards",
            });
            vm.$router.push("/home");
            // console.log("SUCCESS!!");
          })
