    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="buttons">
                    <button class="button" style="font-size: 16px;" onclick="showDatabaseSettings();return false">
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="form-group {{ $errors->has('database_connection') ? ' has-error ' : '' }}">
                    ...
                    <select name="database_connection" id="database_connection" class="db_input">
                ...
                <div class="form-group {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_hostname" class="db_input" id="database_hostname" value="127.0.0.1" placeholder="{{ trans('installer_messages.environment.wizard.form.db_host_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_port') ? ' has-error ' : '' }}">
                    ...
                    <input type="number" name="database_port" class="db_input" id="database_port" value="3306" placeholder="{{ trans('installer_messages.environment.wizard.form.db_port_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_name') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_name" class="db_input" id="database_name" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.db_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_username') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="database_username" class="db_input" id="database_username" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.db_username_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
                    ...
                    <input type="password" name="database_password" class="db_input" id="database_password" value="" placeholder="{{ trans('installer_messages.environment.wizard.form.db_password_placeholder') }}" />
                ...
                <div class="buttons">
                    <button class="button" id="btn-test" style="font-size: 16px;">
                        Check Connection
                        &nbsp;<i class="fa fa-wifi fa-fw" style="font-size:14px;"></i>
                    </button>
                    <button class="button" id="btn-next" style="font-size: 16px; display: none;" onclick="showApplicationSettings();return false">
            ...
            <div class="tab" id="tab3content">
                ...
                <div class="buttons">
                    <button class="button" style="font-size: 16px;" type="submit">
