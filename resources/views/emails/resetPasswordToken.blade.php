                                ...
                                <tr>
                                    <td style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            ...
                                            We received a reset password request for your Account. Copy this code 
                                            as a <b>Token Reset</b> and follow link below to reset your password. <b>Please</b> 
                                            ignore this token if you did not request it.
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                        <div style="line-height: 26px;">
                                            <a href="{{ $details['link'] }}/resetPassword" style="color: #ffffff; text-decoration: none;">
                                                RESET PASSWORD</a>
                                        </div>
                                    </td>
                                </tr>
