                                ...
                                <tr>
                                    <td style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            ...
                                            Thank you for uploading your deposit titled "<b>{{ $details['body'] }}</b>" on DIGITAL REPOSITORY. Your 
                                            sent deposit will soon be <b>checked & verified</b> by our Team. We will inform you about 
                                            the Approval Status afterwards.
