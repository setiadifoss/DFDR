                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            <div style="line-height: 35px">
                                REGISTRATION <span style="color: #5caad2;">DIGITAL REPOSITORY</span>
                            </div>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            ...
                                            Thank you for signing up on DIGITAL REPOSITORY. Your Account data will soon be <b>checked 
                                            & verified</b> by our Team. We will inform you about your Approval Status afterwards.
