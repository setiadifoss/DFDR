        ...
        <tr>
            <td align="center">
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            <div style="line-height: 35px">
                                WELCOME TO <span style="color: #5caad2;">DIGITAL REPOSITORY</span>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" width="100" align="center" cellpadding="0" cellspacing="0" bgcolor="eeeeee">
                                <tr>
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" width="510" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px">
                                            Hello <b>{{ $details['title'] }}</b>,

                                            <br><br><br>

                                            We're happy you signed up for DIGITAL REPOSITORY. Your Account has been successfuly <b>checked 
                                            & verified</b> by our Team. Enter this code below as your current password to Log In to your Account.
                                            ...
                                            <b>Please</b> do not share or tell to anyone about your Password even for DIGITAL REPOSITORY Team.
                                            Change your Password on <b>My Profile</b> menu as soon as you Log In to your Account.
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                        <div style="line-height: 26px;">
                                            <a href="{{ $details['link'] }}/login" style="color: #ffffff; text-decoration: none;">LOGIN TO SITE</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <tr>
                        <td>
                            <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                <tr>
                                    <!-- logo -->
                                    <td align="left" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                                        <span style="color: #5caad2;">DIGITAL REPOSITORY</span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
                                        <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                            Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">contact@example.com</a>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                <tr>
                                    <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            <span style="color: #333333;">DIGITAL REPOSITORY 2021</span>
                                        </div>
                                    </td>
                                </tr>
                            </table>
